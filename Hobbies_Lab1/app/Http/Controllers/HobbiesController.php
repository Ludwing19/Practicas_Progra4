...
class HobbiesController extends Controller
{
    ...
    {
        //
        $data ['hobbies'] = Hobbie::paginate(4);
    ...
    {
        //
            $hobbieData = request()->except ('_token');
            Hobbie::insert($hobbieData);
    ...
    {
        //
        $hobbieData = request ()-> except(['_token', '_method']);
        Hobbie::where('id', '=', $id)->update($hobbieData);
        return redirect ('hobbie');
    }
